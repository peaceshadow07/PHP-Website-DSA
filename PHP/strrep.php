...
<h2><b>Replace first 'the' with 'That' in String</b></h2>
...
<input type="submit" value="Replace" name="s"></br></br>
</form>
...
if(isset($_POST['s']) && $flag)
{
	...
	$n = strpos($string,"the");
	$string=substr_replace($string,"That",strpos($string,"the"),strlen("the"));
